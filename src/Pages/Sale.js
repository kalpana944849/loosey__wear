...
import "../stylesheets/Common/Sale.scss";
...
function Sale() {
  ...
  return (
    <div className="sale">
      <div className="sale__para">
        <p className="heading">SUMMER COLLECTION</p>
        <p>On Sale T-Shirts</p>
      </div>
      <div className="row">
        {Cards.map((item) => (
          <div className="sale__cards">
            ...
            <div className="overlay__icons">
              <div className="icons">
                <div>
                  <i class="fa fa-shopping-basket" aria-hidden="true" onClick={redirectDetail}></i>
                </div>
